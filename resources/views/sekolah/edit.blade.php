...
<form action='{{url('sekolah')}}' method="post" class="mt-5">
    @csrf
    @method('put')
<input type="hidden" name="id" value="{{$data_sekolah->id}}">
    <div class="form-group">
      <label for="nama_sekolah">nama_sekolah</label>
    <input type="text" value="{{$data_sekolah->nama_sekolah}}" name="nama_sekolah" id="nama_sekolah" class="form-control" placeholder="nama sekolah">
  </div>
  ...
  @endif  
    ...
    <div class="form-group">
      ...
      <input type="text" value="{{$data_sekolah->daftar_hari}}"name="daftar_hari" id="daftar_hari" class="form-control" placeholder="daftar hari" aria-describedby="helpId">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="number"value="{{$data_sekolah->jumlah_jam}} min="1" max="11" name="daftar_jam" id="daftar_jam" class="form-control" placeholder="Jam Dimulai ke" >
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" value="{{$data_sekolah->jam_masuk}}"name="jam_masuk" id="jam_masuk" class="form-control" placeholder="Jam Dimulai ke" >
      </div>
      ...
      <div class="form-group">
          ...
          <input type="text" value="{{$data_sekolah->jam_pulang}}"name="jam_pulang" id="jam_pulang" class="form-control" placeholder="Jam Dimulai ke" >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{$data_sekolah->jam_istirahat}}"name="jam_istirahat" id="jam_istirahat" class="form-control" placeholder="Jam Dimulai ke" >
          </div>
    ...
    <div class="form-group">
      ...
      <input type="number" value="{{$data_sekolah->perjam}}" name="perjam" id="perjam" class="form-control" placeholder="Jam Dimulai ke" >
    </div>
